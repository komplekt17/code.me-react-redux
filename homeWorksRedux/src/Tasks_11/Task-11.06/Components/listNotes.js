			...
			<div key={index} className="list-group-item">
				<div className="todo-list-item">
					...
					<div
						...
						onClick={(ev)=>buttonsOperation("ToggleDone", index)}>
						{item.note}
        			</div>
					<div className={classNames2}>
						...
						<div className="input-group-append">
						  	<button
								onClick={()=>saveEditNote(index, item.note)}
				...
				<div className={classNames3}>
					<button
						...
						onClick={()=>buttonsOperation("editNote", index)}>
						<i className="fa fa-edit" />
					</button>
					<button
						type="button"
						className="btn btn-outline-danger btn-sm"
						onClick={(ev)=>buttonsOperation("deleteNote", index)}>
						<i className="fa fa-trash" />
					</button>
					<button
						type="button"
						className="btn btn-outline-warning btn-sm"
						onClick={(ev)=>buttonsOperation("importantNote", index)}>
